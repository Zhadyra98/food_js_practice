window.addEventListener('DOMContentLoaded', function() {
    ...
    getResource('http://localhost:3000/menu')
        .then(data => {
            data.forEach( ({img, altimg, title, descr, price} )=> {//здесь используется деструктуризация массива , когда массив разбиваем на его элементы(ключи)
    ...
    function initLocalChoice (selector, activeClass){
    ...
    initLocalChoice('#gender div', 'calculating__choose-item_active');
    initLocalChoice('.calculating__choose_big div', 'calculating__choose-item_active');
